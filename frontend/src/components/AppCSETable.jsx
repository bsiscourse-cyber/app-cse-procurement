                ...
                {itemsByCategory[cat].map((item) => {
                  ...
                  return (
                    <tr key={`item_${item.id}`}>
                      ...
                      {/* Jan, Feb, Mar */}
                      <td className="text-center"><input type="number" min="0" title="January" disabled={readOnly} className="qty-input" value={jan || ''} onChange={(e) => handleQtyChange(item.id, 'jan', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="February" disabled={readOnly} className="qty-input" value={feb || ''} onChange={(e) => handleQtyChange(item.id, 'feb', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="March" disabled={readOnly} className="qty-input" value={mar || ''} onChange={(e) => handleQtyChange(item.id, 'mar', e.target.value)} /></td>
                      {/* Q1 Auto */}
                      <td className="auto-calc text-center">{q1Qty}</td>
                      <td className="auto-calc">{formatCurrency(q1Amount)}</td>

                      {/* Apr, May, Jun */}
                      <td className="text-center"><input type="number" min="0" title="April" disabled={readOnly} className="qty-input" value={apr || ''} onChange={(e) => handleQtyChange(item.id, 'apr', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="May" disabled={readOnly} className="qty-input" value={may || ''} onChange={(e) => handleQtyChange(item.id, 'may', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="June" disabled={readOnly} className="qty-input" value={jun || ''} onChange={(e) => handleQtyChange(item.id, 'jun', e.target.value)} /></td>
                      {/* Q2 Auto */}
                      <td className="auto-calc text-center">{q2Qty}</td>
                      <td className="auto-calc">{formatCurrency(q2Amount)}</td>

                      {/* Jul, Aug, Sep */}
                      <td className="text-center"><input type="number" min="0" title="July" disabled={readOnly} className="qty-input" value={jul || ''} onChange={(e) => handleQtyChange(item.id, 'jul', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="August" disabled={readOnly} className="qty-input" value={aug || ''} onChange={(e) => handleQtyChange(item.id, 'aug', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="September" disabled={readOnly} className="qty-input" value={sep || ''} onChange={(e) => handleQtyChange(item.id, 'sep', e.target.value)} /></td>
                      {/* Q3 Auto */}
                      <td className="auto-calc text-center">{q3Qty}</td>
                      <td className="auto-calc">{formatCurrency(q3Amount)}</td>

                      {/* Oct, Nov, Dec */}
                      <td className="text-center"><input type="number" min="0" title="October" disabled={readOnly} className="qty-input" value={oct || ''} onChange={(e) => handleQtyChange(item.id, 'oct', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="November" disabled={readOnly} className="qty-input" value={nov || ''} onChange={(e) => handleQtyChange(item.id, 'nov', e.target.value)} /></td>
                      <td className="text-center"><input type="number" min="0" title="December" disabled={readOnly} className="qty-input" value={decm || ''} onChange={(e) => handleQtyChange(item.id, 'decm', e.target.value)} /></td>
                      {/* Q4 Auto */}
